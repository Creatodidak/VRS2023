...
public class DataPosyanduAdapter extends RecyclerView.Adapter<DataPosyanduAdapter.ViewHolder> {
    ...
    private final List<RingkasanStunting.Dataposyandu> dataList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (data.isAda()) {
            ...
            holder.tvAnak.setText(data.getJumanak() + " Orang"); // Konversi ke string
            holder.tvIbuHamil.setText(data.getJumibuhamil() + " Orang"); // Konversi ke string
            holder.tvIbuMenyusui.setText(data.getJumibumenyusui() + " Orang"); // Konversi ke string
...
//            holder.tvEPudding.setText(String.valueOf(data.getJummakanan()) + " Paket");
            ...
            if (daftarbingkisanList != null && !daftarbingkisanList.isEmpty()) {
                ...
                holder.tvBingkisan.setText(data.getJumbingkisan() + " Paket @ berisikan:\n"+ bingkisanText);
            } else {
            ...
            if (daftarmakananList != null && !daftarmakananList.isEmpty()) {
                ...
                holder.tvEPudding.setText(data.getJummakanan() + " Paket @ berisikan:\n"+ makananText);
            } else {
