...
public class ListvercekhotspotItem implements Serializable {
	...
	public void setLatlap(int latlap){
		this.latlap = latlap;
	}

	public int getLatlap(){
		return latlap;
	}
	...
	public void setLonglap(int longlap){
		this.longlap = longlap;
	}

	public int getLonglap(){
		return longlap;
	}
	...
	public void setLonghs(Object longhs){
		this.longhs = longhs;
	}

	public Object getLonghs(){
		return longhs;
	}
	...
	public void setLaths(Object laths){
		this.laths = laths;
	}

	public Object getLaths(){
		return laths;
	}
