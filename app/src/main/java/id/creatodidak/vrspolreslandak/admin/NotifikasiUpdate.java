    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btkirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<ResponseNotif> call = endpoint.kirimUpdateNotif(title, body, topic, "NOTIFIKASI_VRS");
                    ...
                    public void onResponse(Call<ResponseNotif> call, Response<ResponseNotif> response) {
                        if(response.isSuccessful() && response.body() != null){
                            ...
                            builder.setTitle("SUKSES!")
                                    .setMessage("SUKSES: "+ response.body().getSuccess() +"\nGAGAL: "+ response.body().getFailure())
