...
public class TambahDataIbuHamil extends AppCompatActivity {

    EditText etnama, etnik, ettanggallahir, etpekerjaan, etrt, etrw, etbb, etlp, etusia, etdenyut, etsistolik, etdiastolik;
    Spinner spprov, spkab, spkec, spdes, spdus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etlp = findViewById(R.id.etLPIbu);
        etusia = findViewById(R.id.etUsiaKandungan);
        etdenyut = findViewById(R.id.etDenyutJantungBayi);
        ...
        regis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    if (isDataValid()) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(TambahDataIbuHamil.this);
    ...
    private void kirimdata() {
        ...
        Call<Respstunting> call = endpointStunting.sendRegistrasiDataIbu(nama, nik, tanggallahir, pekerjaan, rt, rw, bb, lp, usia, denyut, sistolik, diastolik, prov, kab, kec, des, dus, valcb1, valcb2, valcb3, valcb4, satker);
                    ...
                    if(response.body().isOps()){
                        ...
                        builder.setTitle("DATA BERHASIL DIKIRIM")
                                ...
                                .setPositiveButton("LANJUTKAN", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        TambahDataIbuHamil.super.onBackPressed();
                                        finish();
                                    }
                                })
                                .setIcon(R.drawable.icon)
        ...
        call.enqueue(new Callback<List<ListProv>>() {
            ...
            public void onResponse(Call<List<ListProv>> call, Response<List<ListProv>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    ArrayAdapter<String> provAdapter = new ArrayAdapter<>(TambahDataIbuHamil.this, android.R.layout.simple_spinner_item, namaProvinsiList);
        ...
        call.enqueue(new Callback<List<ListKab>>() {
            ...
            public void onResponse(Call<List<ListKab>> call, Response<List<ListKab>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    ArrayAdapter<String> kabAdapter = new ArrayAdapter<>(TambahDataIbuHamil.this, android.R.layout.simple_spinner_item, namaKabupatenList);
        ...
        call.enqueue(new Callback<List<ListKec>>() {
            ...
            public void onResponse(Call<List<ListKec>> call, Response<List<ListKec>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    ArrayAdapter<String> kecAdapter = new ArrayAdapter<>(TambahDataIbuHamil.this, android.R.layout.simple_spinner_item, namaKecamatanList);
        ...
        call.enqueue(new Callback<List<ListDes>>() {
            ...
            public void onResponse(Call<List<ListDes>> call, Response<List<ListDes>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    ArrayAdapter<String> desAdapter = new ArrayAdapter<>(TambahDataIbuHamil.this, android.R.layout.simple_spinner_item, namaDesaList);
        ...
        call.enqueue(new Callback<List<ListDus>>() {
            ...
            public void onResponse(Call<List<ListDus>> call, Response<List<ListDus>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    ArrayAdapter<String> dusundapter = new ArrayAdapter<>(TambahDataIbuHamil.this, android.R.layout.simple_spinner_item, namaDusunList);
