...
public class Dokstunting extends AppCompatActivity {
    ...
    private final List<String> jenis = Arrays.asList("PILIH JENIS DOKUMENTASI", "KEGIATAN", "AKTIVITAS PIMPINAN", "PENGUKURAN ANTROPOMETRI DAN PEMERIKSAAN KESEHATAN ANAK", "PEMERIKSAAN KESEHATAN IBU", "EDUKASI KEPADA PESERTA", "PEMBERIAN PAKET BINGKISAN", "PEMBERIAN MAKANAN ASUPAN GIZI TAMBAHAN");
