...
public class TambahDataPerkembanganIbuMenyusui extends AppCompatActivity implements View.OnClickListener {
    EditText etnik, etbb, etsistolik, etdiastolik;
    Spinner spstatusasi;
    CheckBox cb1, cb2, cb3, cb4;
    private final List<String> statusAsiList = Arrays.asList("INTESITAS ASI", "NORMAL", "KURANG", "LEBIH");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_data_perkembangan_ibu_menyusui);
        ...
        spstatusasi = findViewById(R.id.spRegStatusAsi2);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.btSearch){
            if(etnik.getText().toString().length() == 16){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(TambahDataPerkembanganIbuMenyusui.this);
    ...
    private void kirimdata() {
        ...
        Call<Respstunting> call = endpointStunting.sendDataKembangibumenyusui(nik, bb, statusasi, sistolik, diastolik, valcb1, valcb2, valcb3, valcb4, satker);
                    ...
                    if(response.body().isOps()){
                        ...
                        builder.setTitle("DATA BERHASIL DIKIRIM")
                                ...
                                .setPositiveButton("LANJUTKAN", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        TambahDataPerkembanganIbuMenyusui.super.onBackPressed();
                                        finish();
                                    }
                                })
                                .setIcon(R.drawable.icon)
