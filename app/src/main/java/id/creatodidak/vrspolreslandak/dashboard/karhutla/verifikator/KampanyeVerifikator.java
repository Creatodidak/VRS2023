...
public class KampanyeVerifikator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kampanye_verifikator);
        ...
        adapter = new ListVerKampanyeAdp(this, list, new ListVerKampanyeAdp.OnItemClickListener() {
            ...
            public void onClick(ListverkampanyeItem data) {
                Intent intent = new Intent(KampanyeVerifikator.this, ShowKampanyeDataVerifikator.class);
        ...
        icCalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new CustomDatePickerDialog(KampanyeVerifikator.this, new CustomDatePickerDialog.OnDateSetListener() {
                    @Override
