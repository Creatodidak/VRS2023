        ...
        call.enqueue(new Callback<RingkasanStunting>() {
            ...
            public void onResponse(Call<RingkasanStunting> call, Response<RingkasanStunting> response) {
                ...
                if (response.body().getJumIbuToday() - response.body().getJumIbuYesterday() < 0) {
                    ...
                    tibuhamil.setText("🔼 " + (response.body().getJumIbuToday() - response.body().getJumIbuYesterday()));
                ...
                if (response.body().getJumibumenyusuiToday() - response.body().getJumibumenyusuiYesterday() < 0) {
                    ...
                    tibumenyusui.setText("🔼 " + (response.body().getJumibumenyusuiToday() - response.body().getJumibumenyusuiYesterday()));
                ...
                if (response.body().getJumGiziBuruk() - response.body().getTotalGiziBuruk() < 0) {
                    ...
                    tG1.setText("🔼 " + (response.body().getJumGiziBuruk() - response.body().getTotalGiziBuruk()));
                ...
                if (response.body().getJumGiziKurang() - response.body().getTotalGiziKurang() < 0) {
                    ...
                    tG2.setText("🔼 " + (response.body().getJumGiziKurang() - response.body().getTotalGiziKurang()));
                ...
                if (response.body().getJumGiziBaik() - response.body().getTotalGiziBaik() < 0) {
                    ...
                    tG3.setText("🔼 " + (response.body().getJumGiziBaik() - response.body().getTotalGiziBaik()));
                ...
                if (response.body().getJumGiziLebih() - response.body().getTotalGiziLebih() < 0) {
                    ...
                    tG4.setText("🔼 " + (response.body().getJumGiziLebih() - response.body().getTotalGiziLebih()));
                ...
                if (response.body().getJumGiziLebihLebih() - response.body().getTotalGiziLebihLebih() < 0) {
                    ...
                    tG5.setText("🔼 " + (response.body().getJumGiziLebihLebih() - response.body().getTotalGiziLebihLebih()));
                ...
                if (response.body().getJumObesitas() - response.body().getTotalObesitas() < 0) {
                    ...
                    tG6.setText("🔼 " + (response.body().getJumObesitas() - response.body().getTotalObesitas()));
                ...
                if(response.body().getTotAnak() != 0){
                    giatJanak.setText(" "+ response.body().getTotAnak() + " Orang");
                }

                if(response.body().getJumIbuToday() != 0){
                    giatJibuhamil.setText(" "+ response.body().getJumIbuToday() + " Orang");
                }

                if(response.body().getJumibumenyusuiToday() != 0){
                    giatJibumenyusui.setText(" "+ response.body().getJumibumenyusuiToday() + " Orang");
                }

                if(response.body().getTotalBingkisan() != 0){
                    jbingkisan.setText(" "+ response.body().getTotalBingkisan() + " Paket");
                }

                tt1.setText("Total: " + response.body().getTotalGizi().getGiziBuruk());
                tt2.setText("Total: " + response.body().getTotalGizi().getGiziKurang());
                tt3.setText("Total: " + response.body().getTotalGizi().getGiziBaik());
                tt4.setText("Total: " + response.body().getTotalGizi().getResikoGiziLebih());
                tt5.setText("Total: " + response.body().getTotalGizi().getGiziLebih());
                tt6.setText("Total: " + response.body().getTotalGizi().getObesitas());
                totibuhamil.setText("Total: " + response.body().getTotIbu());
                totibumenyusui.setText("Total: " + response.body().getTotibumenyusui());
                ...
                jgiat.setText(jumlahgiats + " GIAT");
