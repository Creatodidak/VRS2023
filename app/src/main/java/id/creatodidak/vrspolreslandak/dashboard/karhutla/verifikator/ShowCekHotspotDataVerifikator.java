...
public class ShowCekHotspotDataVerifikator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (jabatan.contains("KABAG") && item.getVerifikasi().equals("MENUNGGU VERIFIKASI KABAG OPS") ||
        ...
        if(jabatan.contains("KABAG")){
            ...
            ditolak = "DITOLAK KABAG OPS";
        }else if(jabatan.contains("KAPOLSEK")){
            diterima = "MENUNGGU VERIFIKASI KABAG OPS";
        ...
        btnTerima.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CustomDialog.up(
                        ShowCekHotspotDataVerifikator.this,
                        "Konfirmasi",
                        ...
                        new CustomDialog.AlertDialogListener() {
                            ...
                            public void onPositiveButtonClick(AlertDialog alert) {
                                alert.dismiss();
                                verifikasi(item.getId(), finalDiterima);
                            }
            ...
            public void onClick(View view) {
                CustomDialog.up(
                        ...
                        new CustomDialog.AlertDialogListener() {
                            ...
                            public void onPositiveButtonClick(AlertDialog alert) {
                                alert.dismiss();
                                verifikasi(item.getId(), finalDitolak);
                            }
