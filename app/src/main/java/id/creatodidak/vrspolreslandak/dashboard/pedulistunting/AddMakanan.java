...
public class AddMakanan extends AppCompatActivity implements AdapterItem.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdditem = findViewById(R.id.btnTambahItemMakanan);
        item = findViewById(R.id.rvItemMakanan);
    ...
    private void loadData() {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddMakanan.this);
            ...
            public void onResponse(Call<ModelItem> call, Response<ModelItem> response) {
                if(response.isSuccessful() && response.body() != null){
                    if(response.body().isAda()){
                        ...
                        AdapterItem adapter = new AdapterItem(AddMakanan.this, itemList, AddMakanan.this);

                        RecyclerView.LayoutManager lm = new LinearLayoutManager(AddMakanan.this);
