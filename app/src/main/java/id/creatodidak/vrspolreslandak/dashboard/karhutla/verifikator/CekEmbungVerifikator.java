...
public class CekEmbungVerifikator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cek_embung_verifikator);
        ...
        adapter = new ListVerCekEmbungAdp(this, list, new ListVerCekEmbungAdp.OnItemClickListener() {
            ...
            public void onClick(ListvercekembungItem data) {
                Intent intent = new Intent(CekEmbungVerifikator.this, ShowCekEmbungDataVerifikator.class);
        ...
        icCalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new CustomDatePickerDialog(CekEmbungVerifikator.this, new CustomDatePickerDialog.OnDateSetListener() {
                    @Override
