...
public class ListVerKampanyeAdp extends RecyclerView.Adapter<ListVerKampanyeAdp.ViewHolder> {
    private List<ListverkampanyeItem> list;
    private ListVerKampanyeAdp.OnItemClickListener onItemClickListener;
    private Context context;
    private SharedPreferences sh;
    private String jabatan;
    public ListVerKampanyeAdp(Context context, List<ListverkampanyeItem> list, ListVerKampanyeAdp.OnItemClickListener onItemClickListener){
    ...
    @Override
    public void onBindViewHolder(@NonNull ListVerKampanyeAdp.ViewHolder holder, int position) {
        ListverkampanyeItem item = list.get(position);
